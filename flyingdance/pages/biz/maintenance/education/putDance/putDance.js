  ...
  sub:function(options){
    ...
    wx.showModal({
      ...
      success: function (sm) {
        ...
        wx.request({
            url: api.apiUrl+'ResourceServlet?method=addDance&picSrc='+picSrc+"&putid="+putid+"&putname="+putname+"&videoSrc="+videoSrc+"&title="+title+"&content="+content+"&coursetype="+coursetype,
            data: {
            },
            method: 'GET',
            header: {
